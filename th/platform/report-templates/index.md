...
- [UI Screens](./ui-screens.md) — ทัวร์ของแท็บ editor XML แบบ CodeMirror, marker การ validate แบบ live, แท็บ Dialog Preview, chip input ของ BU และแถบ action ติดล่างพร้อมตัวบ่งชี้การเปลี่ยนแปลงที่ยังไม่ได้บันทึก
- [XML Spec](./xml-spec.md) — เอกสารอ้างอิงสำหรับ schema XML ของ Dialog และ Content — root element, โครงสร้างของ child และ pattern การจับคู่ Label + Date/Lookup ที่ใช้ใน form ตัวกรอง
