...
- [Tenant Migrations](/th/platform/business-units/tenant-migrations) — pointer สั้น ๆ ครอบคลุมเฉพาะการ์ด `TenantMigrationCard` ต่อ BU ที่ฝังอยู่ในแท็บ Technical ของหน้าแก้ไข ส่วนหน้าจอ `/tenant-migrations` ระดับ fleet เองบันทึกไว้เต็มรูปแบบที่โมดูล [Tenant Migrations](/th/platform/tenant-migrations) แบบ standalone
