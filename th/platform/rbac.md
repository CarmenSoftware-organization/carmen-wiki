...
สรุปไว้เท่านั้นในหน้านี้ — ดูหมายเหตุขอบเขตด้านบนว่าทำไม และดูหน้าโมดูลของตัวเองสำหรับเนื้อหาแบบละเอียด:
