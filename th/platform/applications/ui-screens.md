...
| Device | ข้อความสีจางเงียบๆ ผ่าน `formatDevice()` (เช่น `POS`, `Mobile`) — ไม่ใช่ `Badge` อีกต่อไป เพราะ `#254` เห็นว่า pill รายแถวซ้ำซ้อนกับ histogram อุปกรณ์ของแถบ Registry แล้ว |
