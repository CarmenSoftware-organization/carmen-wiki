...
- [print-template-mapping](/th/platform/print-template-mapping) — **ถูกลบเมื่อ 2026-07-23/24** (หน้าเชิงประวัติศาสตร์เท่านั้น); เคยเป็นตาราง routing ที่ตัดสินว่าเทมเพลต `kind="print"` ตัวไหน render เอกสารแต่ละประเภท ตอนนี้การตัดสินใจนั้นทำบนตารางนี้โดยตรงผ่าน `template_type = "form"` + `report_group` + `is_default` แสดงผลผ่านหน้าจอ [Form Groups](/th/platform/report-templates/form-groups) ใหม่ — ดูหน้า print-template-mapping สำหรับ timeline การถูกลบฉบับเต็มและความสามารถหนึ่งอย่างที่ไม่ได้ย้ายมาด้วย (การกำหนด default ต่อ BU)
