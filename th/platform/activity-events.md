...
- `../carmen-inventory-frontend-react/lib/analytics.ts` (เต็ม 223 บรรทัด, HEAD `72d6cd340`, 2026-09-04) — ตัว batcher telemetry: `enqueue`, `deriveElementId`, `collectTrackProps`, `flush`, กฎการ batch/retry/ปิดใช้งาน
