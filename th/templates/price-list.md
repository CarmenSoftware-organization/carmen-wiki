...
| "Currency not active" | `tb_currency.is_active = false` | activate currency ภายใต้ [[master-data/currency]] |
...
- [[vendor-pricelist]] — ผู้บริโภคเพียงรายเดียว รอบ RFQ spawn จาก template
- [[master-data/currency]] — การ resolve `currency_id`
