...
| `current_stage_status` | `String @db.VarChar` | Yes | Working copy ของ status stage ปัจจุบัน |
...
- โมดูลที่เกี่ยวข้อง: [[purchase-request]] (ต้นทาง upstream), [[good-receive-note]] (fulfilment ปลายน้ำผ่าน `received_qty`), [[product]] (อ้างอิงสินค้าบรรทัด), [[vendor-pricelist]] (snapshot ราคา ณ เวลา PR-to-PO conversion), [[inventory]] (context on-hand)
