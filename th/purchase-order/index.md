...
**การไหลข้ามโมดูล:**
- [[purchase-request]] — PO สร้างจาก PR ที่อนุมัติแล้ว
- [[good-receive-note]] — GRN ถูกสร้างกับ PO เมื่อรับของ
- [[vendor-pricelist]] — ราคา PO ถูก validate กับ vendor pricelist
- [[product]] — บรรทัด PO อ้างอิงสินค้าจากแคตตาล็อก

**Master configuration:**
- [[master-data/vendor]] — vendor master (header + addresses + contacts) ที่ส่วนหัว PO อ้างอิง
- [[master-data/currency]] — สกุลเงินและอัตราแลกเปลี่ยนสำหรับ PO หลายสกุลเงิน
- [[master-data/tax-profile]] — รหัสภาษีที่ใช้กับบรรทัด PO
- [[master-data/credit-term]] — เงื่อนไขการชำระเงินที่คัดลอกจาก vendor master ลงในส่วนหัว PO
- [[master-data/delivery-point]] — จุดส่งของที่ตกลงกันสำหรับ commitment
- [[master-data/unit]] — หน่วยนับสำหรับปริมาณบรรทัด PO
- [[system-config/workflow]] — นิยาม workflow อนุมัติสำหรับการอนุญาต PO และ amendments
- [[system-config/running-code]] — การเรียงลำดับเลขเอกสาร PO
- [[reporting-audit/activity]] — log การเปลี่ยนสถานะ PO การ amendment และ three-way-match สำหรับ audit
- [[reporting-audit/attachment]] — vendor acknowledgements และเอกสาร contract ที่แนบกับ PO
...
- [02 — กติกาทางธุรกิจ](./02-business-rules.md) — การตรวจสอบความถูกต้อง การคำนวณ การกำหนดสิทธิ์ การ posting และกฎ three-way-match
...
- [04 — Test Scenarios](./04-test-scenarios.md) — ขอบเขตของแต่ละ persona, scenario ข้าม persona และ E2E mapping
