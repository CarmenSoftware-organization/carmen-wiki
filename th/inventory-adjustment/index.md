...
**กระแสข้ามโมดูล:**
- [[inventory]] — adjustments แก้ไขยอดสต๊อกโดยตรง
- [[costing]] — adjustments ต้องการ cost basis (ใส่ด้วยมือหรือจาก costing engine)
- [[physical-count]] — ผลต่างการนับกลายเป็นเอกสาร adjustment
- [[spot-check]] — ผลต่างจากการนับบางส่วนกลายเป็นเอกสาร adjustment

**การกำหนดค่า master:**
- [[master-data/adjustment-type]] — master ของ reason code พร้อมทิศทาง (IN/OUT/BOTH) และ GL mapping ต่อเหตุผล
- [[master-data/unit]] — หน่วยนับสำหรับปริมาณแต่ละบรรทัด
- [[master-data/location]] — ตำแหน่งต้นทางที่ adjustment ขยับยอด
- [[system-config/workflow]] — นิยาม workflow การอนุมัติสำหรับการอนุญาต adjustment
- [[system-config/period]] — gate งวดบัญชี; adjustments ที่ลงวันที่ในงวดที่ปิดถูก reject
- [[access-control/user-location]] — จำกัดตำแหน่งที่ผู้ใช้สามารถปรับได้
- [[reporting-audit/activity]] — log การเปลี่ยนสถานะ adjustment สำหรับ audit
- [[reporting-audit/attachment]] — รูปถ่ายที่จำเป็น / รายงานความเสียหาย / หลักฐาน เก็บกับ adjustment
...
- [02 — กติกาทางธุรกิจ](./02-business-rules.md) — การตรวจสอบ การคำนวณ การกำหนดสิทธิ์ การ posting และกฎข้ามโมดูล
- [03 — User Flow](./03-user-flow.md) — วงจรชีวิตเอกสาร พร้อมสารบัญ persona
