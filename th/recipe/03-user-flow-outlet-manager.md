...
> **At a Glance**
> **Persona:** Outlet Manager &nbsp;·&nbsp; **โมดูล:** [[recipe]] &nbsp;·&nbsp; **ขั้นตอน workflow:** off-path — บริโภคสูตร PUBLISHED สำหรับการวางแผน demand และการติดตาม variance &nbsp;·&nbsp; **สิทธิ์สำคัญ:** อ่านสูตร; author / submit SR ปลายน้ำ; ยก feedback ไปยัง Chef
...
- **SR submit ไปยังคลังกลาง** — handoff ไปยัง **Approver** และ **Fulfiller** ใน flow [[store-requisition]] (วงจรชีวิตของ SR ดำเนินต่อโดยอิสระ); Outlet Manager ติดตามแต่ไม่ advance สถานะของ SR
...
- **Variance attribute ไปที่ shrinkage** — handoff ไปยัง **Audit / Config (Inventory Controller)** สำหรับการสอบสวนผ่าน `[[inventory-adjustment]]`; Outlet Manager ให้บริบทปฏิบัติการแต่การ resolve อยู่ที่ inventory layer
...
- ที่เกี่ยวข้อง: [[store-requisition]] — เอกสารปลายน้ำหลักที่ Outlet Manager author; demand สูตร seed SR
- ที่เกี่ยวข้อง: [[inventory]] — การกระทบยอด on-hand ของ outlet กับการใช้เชิงทฤษฎีที่ recipe-driven คือการคำนวณ food-cost-variance
- ที่เกี่ยวข้อง: [[inventory-adjustment]] — movement แก้ไขสำหรับ shrinkage / spoilage ที่ flag โดยการสอบสวน variance
