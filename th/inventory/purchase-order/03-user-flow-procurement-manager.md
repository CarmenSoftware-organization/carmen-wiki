...
|---|---|
| ดู PO | ✅ ทุก status |
| Approve ที่ stage ตัวเอง (`in_progress`) | ✅ เมื่อถูก assign ผ่าน `user_action.execute[]` สำหรับ stage ปัจจุบัน (`PO_AUTH_011`) — ไม่มี amount threshold |
...
1. รับ notification stage cursor ของ workflow มาลงที่ stage ของ user นี้เพราะ workflow definition ของ tenant assign ไว้ที่นั่น — ไม่ใช่เพราะการคำนวณ amount หรือ deviation ใด ๆ
