...
- เกี่ยวข้อง: [purchase-request](/th/inventory/purchase-request) — โมดูล upstream; PR-to-PO conversion ผ่านตาราง bridge และ bounce-back target เมื่อ vendor / spec clarification ไม่สามารถกู้คืน
- เกี่ยวข้อง: [vendor-pricelist](/th/inventory/vendor-pricelist) — pricing lookup และ deviation reference ที่ใช้ใน Step 4 ข้างต้น
