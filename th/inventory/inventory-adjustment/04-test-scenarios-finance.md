...
ไม่มี test scenario เฉพาะของ Finance สำหรับโมดูลนี้ วงจร draft → commit → void ที่มีอยู่ตั้งแต่ 2026-07-30 ถูกทดสอบจาก persona จริงสองราย ([Store Keeper](/th/inventory/inventory-adjustment/04-test-scenarios-store-keeper), [Inventory Controller](/th/inventory/inventory-adjustment/04-test-scenarios-inventory-controller)); หากมีพฤติกรรมที่เกี่ยวเนื่องกับ Finance ต้องการการทดสอบ พฤติกรรมนั้นเป็นของ feature ปิดงวดจริงของ [inventory](/th/inventory/inventory) ไม่ใช่โมดูลนี้
