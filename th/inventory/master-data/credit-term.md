...
| ตั้ง default ต่อผู้ขาย | รายละเอียดของ [master-data/vendor](/th/inventory/master-data/vendor) | App-layer; ไม่ได้อยู่บนระเบียนนี้ |
...
- [purchase-order](/th/inventory/purchase-order) — PO header บรรจุ `credit_term_id`; due date = `po_date + value` วัน
- [master-data/vendor](/th/inventory/master-data/vendor) — ผู้ขาย pre-assign default credit term ใน app logic; default ลงบน PO ใหม่
