...
> **At a Glance**
> **โมดูล:** [vendor-pricelist](/th/inventory/vendor-pricelist) &nbsp;·&nbsp; **Persona:** Purchaser (+ Purchasing Manager) &nbsp;·&nbsp; Vendor &nbsp;·&nbsp; Finance &nbsp;·&nbsp; Audit / Config
...
- โมดูลที่เกี่ยวข้อง: [purchase-request](/th/inventory/purchase-request) (PR default ราคาจาก pricelist active), [purchase-order](/th/inventory/purchase-order) (PO snapshot ราคา pricelist + ติดตาม deviation), [good-receive-note](/th/inventory/good-receive-note) (GRN price-variance check), [product](/th/inventory/product) (entry pricelist อ้างอิงสินค้า)
