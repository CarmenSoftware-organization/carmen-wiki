...
- [purchase-request](/th/inventory/purchase-request), [purchase-order](/th/inventory/purchase-order), [good-receive-note](/th/inventory/good-receive-note), [store-requisition](/th/inventory/store-requisition), [inventory-adjustment](/th/inventory/inventory-adjustment), [physical-count](/th/inventory/physical-count), [spot-check](/th/inventory/spot-check) และ [vendor-pricelist](/th/inventory/vendor-pricelist) แต่ละโมดูลมีเส้นทาง "Print" ที่ resolve template ของ [reporting-audit/report](/th/inventory/reporting-audit/report) ผ่าน print mapping ตามประเภทเอกสาร [inventory](/th/inventory/inventory), [costing](/th/inventory/costing), [product](/th/inventory/product) และ [recipe](/th/inventory/recipe) เป็นผู้บริโภคทั่วไปของ analytical report
- Tile ใน [reporting-audit/widget](/th/inventory/reporting-audit/widget) สามารถฝัง template ของ [reporting-audit/report](/th/inventory/reporting-audit/report) ได้ แหล่งข้อมูลของ tile ครอบคลุมทุกโมดูลธุรกรรมข้างต้น
- [master-data/business-unit](/th/inventory/master-data/business-unit) กำหนด scope ของการเข้าถึง template / mapping ของ [reporting-audit/report](/th/inventory/reporting-audit/report) (รายการอนุญาต / ปฏิเสธ BU) และจำกัดการมองเห็น dashboard scope `bu` ของ widget
- [access-control/user](/th/inventory/access-control/user) resolve `actor_id` / `requested_by_id` / `created_by_id` ในทุกเอนทิตีที่นี่ และตัดสินการมองเห็นสำหรับ dashboard ส่วนตัวและ notification ต่อผู้ใช้
- [reporting-audit/notification](/th/inventory/reporting-audit/notification) บริโภค event ที่เขียนโดย [reporting-audit/activity](/th/inventory/reporting-audit/activity) เพิ่มเติมสำหรับ message format บางตัวที่ขับโดย workflow
