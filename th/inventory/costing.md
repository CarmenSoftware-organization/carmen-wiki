...
> **At a Glance**
> **วัตถุประสงค์ของโมดูล:** เอนจินตีมูลค่าระดับธุรกรรมที่คำนวณ COGS สำหรับสินค้าออกและปรับปรุงต้นทุนพื้นฐานของสินค้าเข้าภายใต้ FIFO หรือ Weighted Average &nbsp;·&nbsp; **กลุ่มผู้ใช้:** Finance, Inventory Controller, Auditor &nbsp;·&nbsp; **เอนทิตี/ตารางหลัก:** `tb_period_snapshot`, FIFO cost layers, `AverageCostTracking`, `JournalEntry`, [costing/calculation-methods](/th/inventory/costing/calculation-methods) &nbsp;·&nbsp; **หน้าย่อย:** 11
...
- [master-data/currency](/th/inventory/master-data/currency) — สกุลเงินทำรายการและสกุลเงินฐาน รวมถึงอัตรา FX สำหรับ COGS ที่ dual-post
