...
> **At a Glance**
> **Persona:** Store Keeper (ผู้บริโภค floor read-only; การ lookup barcode-scan) &nbsp;·&nbsp; **โมดูล:** [product](/th/inventory/product) &nbsp;·&nbsp; **scenario:** ~35
...
- spec E2E: ไม่มี spec ด้าน product ของ Store Keeper บนมือถือตรง; การครอบคลุมเป็นทางอ้อมผ่าน [good-receive-note](/th/inventory/good-receive-note) (`501-grn.spec.ts`), [physical-count](/th/inventory/physical-count) / [spot-check](/th/inventory/spot-check) (spec การรันการนับ) และ [store-requisition](/th/inventory/store-requisition) (`701-sr.spec.ts`) — ซึ่ง exercise เส้นทาง barcode-scan และ product-picker จาก flow ธุรกรรมของ Store Keeper scenario ส่วนใหญ่ด้านบนเป็น manual / planned Mobile happy-path fixture ตรงกับ `sk@blueledgers.com`
- Cross-link: [good-receive-note](/th/inventory/good-receive-note) — โมดูลหลักสำหรับ flow barcode-scan ระหว่างการรับ; product master ถูกบริโภคที่ line entry
- Cross-link: [inventory](/th/inventory/inventory) — Store Keeper เขียนผ่าน `tb_stock_in` / `tb_stock_out`; อ่านนโยบาย `tb_product_location`; `INV_AUTH_004` สำรองการแก้นโยบายให้ Inventory Controller
- Cross-link: [physical-count](/th/inventory/physical-count) / [spot-check](/th/inventory/spot-check) — การรันการนับใช้ barcode scan และการอ้างอิงนโยบายตาม Section 1
- Cross-link: [store-requisition](/th/inventory/store-requisition) — SR dispatch ใช้ barcode สำหรับการยืนยันการหยิบตาม SK-HP-05
- Cross-link: [inventory-adjustment](/th/inventory/inventory-adjustment) — stock-in / stock-out จากการปรับด้วยมือ; flag เน่าเสียขับเคลื่อนความต้องการวันหมดอายุที่การสร้าง lot
