...
- ที่เกี่ยวข้อง: [inventory](/th/inventory/inventory) — `tb_product_location` อ่านที่นี่; อำนาจ **edit** เป็นของ Product Administrator บน Locations tab ของโมดูล product เอง (แก้ไขในรอบนี้ — ไม่พบ edit surface แยกในโมดูล inventory; [inventory/02-business-rules](/th/inventory/inventory/02-business-rules) `INV_AUTH_004` เองก็ถูกทำเครื่องหมายเป็น unconfirmed) feedback นโยบายต่อ location route ไปยัง Product Administrator
