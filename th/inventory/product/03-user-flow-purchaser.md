...
- **บรรทัด PR / PO save แล้ว** picker resolve `product_id`; บรรทัดถูก populate และ save บน PR / PO Product master ไม่เปลี่ยน การมีส่วนร่วมของ Purchaser ด้านแคตตาล็อกเสร็จ; งานของพวกเขาดำเนินต่อใน [purchase-request](/th/inventory/purchase-request) / [purchase-order](/th/inventory/purchase-order) ในฐานะเจ้าของเอกสาร
...
- โมดูลที่เกี่ยวข้อง: [purchase-request](/th/inventory/purchase-request) / [purchase-order](/th/inventory/purchase-order) — โมดูลหลักที่ Purchaser เป็นเจ้าของ; product picker ฝังใน line entry ค่าความคลาดเคลื่อนของสินค้า (`PRD_CALC_003`) gate การอนุมัติเกินเกณฑ์บนเอกสารเหล่านี้
- ที่เกี่ยวข้อง: [vendor-pricelist](/th/inventory/vendor-pricelist) — pricelist อ้างอิงสินค้า; Purchaser อ่านเพื่อสนับสนุนการตั้งราคาบรรทัด PR / PO
- ที่เกี่ยวข้อง: [good-receive-note](/th/inventory/good-receive-note) — ต้นทุนการรับจริงของ GRN ป้อนกลับเข้า `tb_inventory_transaction_cost_layer.cost_per_unit` ซึ่งเป็นสิ่งที่ `PRD_CALC_008` (ต้นทุนรับล่าสุด) แสดงกลับให้ Purchaser data flow เป็น round-trip แต่ Purchaser เป็นผู้มีส่วนร่วมด้าน read-side เท่านั้น
