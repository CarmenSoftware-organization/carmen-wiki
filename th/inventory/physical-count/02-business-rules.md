...
> **TODO:** ยืนยันลำดับความสำคัญของค่า `enum_physical_count_costing_method` กับ logic frontend เมื่อ path ของ carmen-inventory-frontend ถูกเขียน Cross-link ไป [costing](/th/inventory/costing) สำหรับพฤติกรรมการตีมูลค่า WA / FIFO
