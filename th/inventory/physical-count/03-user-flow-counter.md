...
- **E2E:** `../carmen-inventory-frontend-e2e/tests/` — ยังไม่มี spec physical-count; manual catalog `docs/test-cases/750-physical-count.md` (case ของหน้า entry / review, ตรวจทานซ้ำ 2026-09-20)
