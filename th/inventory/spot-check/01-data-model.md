...
- **Frontend (TODO):** `../carmen-inventory-frontend-react/` — ยังไม่เห็น route `spot-check` ที่ระดับบนสุด `app/` ค้นใต้โฟลเดอร์โมดูลย่อยเมื่อเขียน UI flow
