...
| ตรวจสอบการเปลี่ยนแปลง dimension | [reporting-audit/activity](/th/inventory/reporting-audit/activity) log | `entity_type = dimension` |
...
- [purchase-request](/th/inventory/purchase-request), [purchase-order](/th/inventory/purchase-order) — การติด tag header + detail
- [good-receive-note](/th/inventory/good-receive-note) — พา cost-centre allocation ไปข้างหน้า
- [store-requisition](/th/inventory/store-requisition) — issue dimensions ขับเคลื่อนการจัดสรรต้นทุน
- [inventory-adjustment](/th/inventory/inventory-adjustment) — การติด tag stock-in / stock-out
- [inventory](/th/inventory/inventory) — การติด tag transfer
- [master-data/vendor](/th/inventory/master-data/vendor), [master-data/location](/th/inventory/master-data/location), [master-data/currency](/th/inventory/master-data/currency), [product](/th/inventory/product) — การติด tag บน master record cascade defaults ไปยังเอกสารธุรกรรม
