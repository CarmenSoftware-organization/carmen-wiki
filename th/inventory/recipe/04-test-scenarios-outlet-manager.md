...
> **At a Glance**
> **Persona:** Outlet Manager (read-only บน recipe library) &nbsp;·&nbsp; **โมดูล:** [[recipe]] &nbsp;·&nbsp; **scenario:** ~23
...
| OM-PERM-06 | Outlet Manager สร้าง SR จาก demand auto-create | **Allow** SR อยู่ในโมดูล [[store-requisition]] ไม่ใช่โมดูล recipe; อำนาจการสร้าง SR ของ Outlet Manager ควบคุมโดย `SR_AUTH_001` ของ SR |
...
- Cross-link: [[store-requisition]] — เอกสารปลายน้ำหลักที่ Outlet Manager author จาก demand สูตร
- Cross-link: [[inventory]] — การกระทบยอด on-hand ของ outlet กับการใช้เชิงทฤษฎีที่ recipe-driven คือการคำนวณ food-cost-variance
- Cross-link: [[inventory-adjustment]] — movement แก้ไขสำหรับ shrinkage / spoilage flag โดยการสอบสวน variance
