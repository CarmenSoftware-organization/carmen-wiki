...
- **(Procurement) ยก PO** — handoff ไปยัง flow PO ของโมดูล procurement (ด้าน vendor [purchase-order](/th/inventory/purchase-order)); input demand สูตรเก็บเป็น rationale สำหรับการขนาด PO; PO advance โดยอิสระ Procurement กลับไปยังโมดูล recipe ในรอบการวางแผนถัดไป
...
- ที่เกี่ยวข้อง: [purchase-order](/th/inventory/purchase-order) — เอกสารปลายน้ำหลักของ Procurement; demand ที่ recipe-driven ขนาด PO
- ที่เกี่ยวข้อง: [vendor-pricelist](/th/inventory/vendor-pricelist) — ข้อมูล cost ของ vendor เป็น input ต้นน้ำของ cost สินค้า ซึ่งเป็นต้นน้ำของ cost สูตร; การเปลี่ยน vendor ไหลผ่านไปยัง event cost drift ของสูตร
- ที่เกี่ยวข้อง: [costing](/th/inventory/costing) — F&B Ops review ข้อมูล cost ที่มาจากโมดูล costing ผ่านสูตร
