...
- ที่เกี่ยวข้อง: [costing](/th/inventory/costing) — ต้นน้ำของทุก feed cost per-ingredient; event cost-drift ไหลจาก `[costing](/th/inventory/costing)` ไปยังโมดูล recipe ตาม `REC_XMOD_006`
- ที่เกี่ยวข้อง: [inventory](/th/inventory/inventory) — dashboard variance ทฤษฎี-vs-จริง join OUT movement เชิงทฤษฎีที่ recipe-driven กับ movement สต๊อกจริง
