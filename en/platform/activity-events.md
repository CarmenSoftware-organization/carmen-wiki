...
- `../carmen-inventory-frontend-react/lib/analytics.ts` (full, 223 lines, HEAD `72d6cd340`, 2026-09-04) — the telemetry batcher: `enqueue`, `deriveElementId`, `collectTrackProps`, `flush`, batching/retry/disable rules.
