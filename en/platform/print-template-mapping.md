...
- [Report Templates](/en/platform/report-templates) — owns the replacement mechanism (`report_group`, `is_default`, the [Form Groups](/en/platform/report-templates/form-groups) screen) and the `tb_report_template` table this module used to point at.
