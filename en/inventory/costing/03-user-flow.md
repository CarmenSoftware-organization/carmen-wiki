...
> **At a Glance**
> **Module:** [costing](/en/inventory/costing) &nbsp;·&nbsp; **Personas:** Finance &nbsp;·&nbsp; Inventory Controller &nbsp;·&nbsp; Auditor
...
| Auditor | Cost-flow chain-of-custody trace complete (forward from a GRN inbound through all downstream consumption) | Finance (cost-impact review) + Inventory Controller (lot-trace operational review) | No transaction state change. The trace report is the deliverable; operational follow-up (recall write-off, vendor blacklisting, lot-aging policy update) lives on the owning persona's flow ([inventory-adjustment](/en/inventory/inventory-adjustment) for write-off, [good-receive-note](/en/inventory/good-receive-note) for vendor handling). |
