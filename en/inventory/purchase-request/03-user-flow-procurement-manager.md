...
- **Send for Review.** `workflow_current_stage` moves back to the chosen stage; if that is the Requestor's create stage, the **Requestor** picks it up ([03-user-flow-requestor.md](./03-user-flow-requestor.md)) — `pr_status` stays `in_progress`.
