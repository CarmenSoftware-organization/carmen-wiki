...
> **At a Glance**
> **Module:** [recipe](/en/inventory/recipe) &nbsp;·&nbsp; **Total scenarios:** ~14 cross-persona + per-persona drill-downs across all personas &nbsp;·&nbsp; **Personas covered:** Chef, Cost Controller, Outlet Manager, Procurement / F&B Ops, Audit / Config
...
- Related modules: [product](/en/inventory/product) (ingredient feed), [inventory](/en/inventory/inventory) (theoretical-consumption fan-out target), [costing](/en/inventory/costing) (cost-drift upstream), [store-requisition](/en/inventory/store-requisition) (downstream auto-create).
