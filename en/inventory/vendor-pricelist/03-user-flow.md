...
Note: **Receiver / Store Keeper** is listed as an "indirect consumer" in [the module landing](/en/inventory/vendor-pricelist) Section 4 — GRN posting reads the active pricelist for variance calculation, but the persona has no write surface on the pricelist module itself. Receiver behaviour is captured in cross-persona scenarios (Section 4 below and in [04-test-scenarios.md](./04-test-scenarios.md)) rather than a dedicated persona file.
