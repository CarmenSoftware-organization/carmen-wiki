...
- [04 — Test Scenarios](/en/inventory/recipe/04-test-scenarios) — Cross-persona scenarios + E2E coverage status (no dedicated `recipe.spec.ts` yet), with per-persona drill-downs:
