...
| Finance closed-period block, journal-entry verification, period close | Journal verification: **not implemented for SR**. Closed-period block: **implemented as a generic gate** — test it from the Requester / Fulfiller pages (REQ-VAL-11, FUL-VAL-06), not as a Finance action. |
...
- Business rules: [02-business-rules.md](./02-business-rules.md) § 2 (`SR_VAL_014`, confirmed 2026-09-22), § 4 (`SR_AUTH_009`–`SR_AUTH_013`, corrected), § 5 (`SR_POST_007`, `SR_POST_009`, `SR_POST_010`, `SR_POST_013`, corrected).
