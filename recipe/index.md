...
- **Actual Consumption**: The inventory the kitchen actually drew down, derived from physical stock-take, store requisitions, and direct issues. The supply-side number for variance.
